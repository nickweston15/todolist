...
module.exports = class SessionPersistence {
  ...
  // Todo list is done if it has at least one todo and every todo is done
  ...
  // success, 'false' if the todo or todo list doens't exist. The id arguments
  ...
  // Returns a copy of the list of todos in the indicated todo list by sorted by completion
  // status and title (case-insensitive)
